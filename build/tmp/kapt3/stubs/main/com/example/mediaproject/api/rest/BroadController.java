...
public class BroadController {
    ...
    @org.jetbrains.annotations.NotNull
    @org.springframework.web.bind.annotation.GetMapping(value = {"/{boardId}/detail"})
    public org.springframework.http.ResponseEntity<com.example.mediaproject.api.response.BoardDetailResponse> getBoardDetail(@org.springframework.web.bind.annotation.PathVariable(value = "boardId")
    long boardId) {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull
    @org.springframework.web.bind.annotation.PatchMapping(value = {"/{boardId}/like"})
    public org.springframework.http.ResponseEntity<com.example.mediaproject.api.response.BoardResponse> patchLikeBoard(@org.springframework.web.bind.annotation.PathVariable(value = "boardId")
    long boardId, @org.springframework.web.bind.annotation.RequestParam(required = true)
    boolean isLiked) {
        return null;
    }
}